...
func openProbe(t *testing.T) {
	t.Helper()
	writeProbe(t)
	shared.Call(t, "browser_open", map[string]any{"url": "file:///tmp/it-probe.html"})
...
func TestBrowserOpen(t *testing.T) {
	...
	out := shared.Call(t, "browser_open", map[string]any{"url": "file:///tmp/it-probe.html"})
...
func TestBrowserGoto(t *testing.T) {
	...
	shared.Call(t, "browser_goto", map[string]any{"url": "file:///tmp/it-second.html"})
	...
	shared.CallErr(t, "browser_goto", map[string]any{
...
func TestBrowserTabs(t *testing.T) {
	...
	out := shared.Call(t, "browser_tabs", nil)
...
func TestBrowserEval(t *testing.T) {
	...
	out := shared.Call(t, "browser_eval", map[string]any{
...
func TestBrowserText(t *testing.T) {
	...
	out := shared.Call(t, "browser_text", nil)
	...
	out = shared.Call(t, "browser_text", map[string]any{"selector": "#para"})
...
func TestBrowserType(t *testing.T) {
	...
	shared.Call(t, "browser_type", map[string]any{"selector": "#field", "text": "hola"})
...
func TestBrowserClick(t *testing.T) {
	...
	shared.Call(t, "browser_click", map[string]any{"selector": "#btn"})
	...
	shared.CallErr(t, "browser_click", map[string]any{"selector": "#no-such-element"})
}
...
func TestBrowserWaitFor(t *testing.T) {
	...
	shared.Call(t, "browser_goto", map[string]any{"url": "file:///tmp/it-probe.html"})

	start := time.Now()
	shared.Call(t, "browser_wait_for", map[string]any{"selector": "#appeared", "timeout_ms": 15000})
	...
	shared.CallErr(t, "browser_wait_for", map[string]any{
...
func TestOpenAppAndWait(t *testing.T) {
	...
	title := "OPENWAITWIN"
	start := time.Now()
	shared.Call(t, "open_app_and_wait", map[string]any{
