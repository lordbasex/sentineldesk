...
func TestGetScreenInfo(t *testing.T) {
	out := shared.Call(t, "get_screen_info", nil)
...
func TestGetDesktopInfo(t *testing.T) {
	out := shared.Call(t, "get_desktop_info", nil)
...
func TestGetMousePosition(t *testing.T) {
	...
	shared.Call(t, "mouse_move", map[string]any{"x": 640, "y": 480})

	out := shared.Call(t, "get_mouse_position", nil)
...
func TestScreenshot(t *testing.T) {
	out := shared.Call(t, "screenshot", map[string]any{"destination": "file"})
...
func TestScreenshotRegion(t *testing.T) {
	...
	raw := shared.CallImage(t, "screenshot_region", map[string]any{
...
func TestReadScreenText(t *testing.T) {
	...
	out := shared.Call(t, "read_screen_text", nil)
...
func TestFindText(t *testing.T) {
	...
	out := shared.Call(t, "find_text", map[string]any{"text": title})
...
func TestListWindows(t *testing.T) {
	...
	out := shared.Call(t, "list_windows", nil)
	if !strings.Contains(out, title) {
...
func TestGetActiveWindow(t *testing.T) {
	...
	eventually(t, 5*time.Second, "the window to take focus", func() bool {
		return strings.Contains(shared.Call(t, "get_active_window", nil), title)
	})
...
func TestListDesktops(t *testing.T) {
	out := shared.Call(t, "list_desktops", nil)
