...
func TestWriteFile(t *testing.T) {
	...
	shared.Call(t, "write_file", map[string]any{"path": path, "content": want})
...
func TestReadFile(t *testing.T) {
	...
	out := shared.Call(t, "read_file", map[string]any{"path": path})
...
func TestListDirectory(t *testing.T) {
	...
	out := shared.Call(t, "list_directory", map[string]any{"path": dir})
...
func TestRunCommand(t *testing.T) {
	...
	out := shared.Call(t, "run_command", map[string]any{
	...
	failed := shared.Call(t, "run_command", map[string]any{
...
func TestListProcesses(t *testing.T) {
	...
	out := shared.Call(t, "list_processes", map[string]any{"filter": "sleep"})
...
func TestIsRunning(t *testing.T) {
	...
	out := shared.Call(t, "is_running", map[string]any{"name": "Xvfb"})
	...
	// everything.
	out = shared.Call(t, "is_running", map[string]any{"name": "definitely-not-a-real-process-xyz"})
	if strings.Contains(out, "true") {
...
func TestKillProcess(t *testing.T) {
	...
	shared.Call(t, "kill_process", map[string]any{"name": "it-kill-me"})
...
func TestListInstalledApps(t *testing.T) {
	out := shared.Call(t, "list_installed_apps", nil)
...
func TestListCommands(t *testing.T) {
	...
	// is actually on PATH.
	out := shared.Call(t, "list_commands", nil)
	...
	out = shared.Call(t, "list_commands", map[string]any{"filter": "chromium", "describe": true})
	...
	out = shared.Call(t, "list_commands", map[string]any{"category": "definitely-no-such-section"})
...
func TestSudoStatus(t *testing.T) {
	out := shared.Call(t, "sudo_status", nil)
